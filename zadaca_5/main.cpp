...
//2.zadatak 
//Vektor tocaka koje se nalaze na krivulji, počevši od prve kontrolne tocke. 
...
public:
	...
	std::vector<glm::vec2> GetCurve() {
		...
		float curveStart = points[0].x;    //pocetna tocka

		float curveLength = 0.0f;        //pocetna duljina

		// udaljenost između tocaka 
...
int main ()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//1.zadatak crtanje kružnica radijusa 5 
...
//4.zadatak 
//Povlacenje kontrolnih tocaka po prozoru koristenjem misa
//c brise sve 
